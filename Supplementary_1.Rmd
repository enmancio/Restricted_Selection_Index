...
png("Scenario1.png", width = 265, height = 125, units='mm',res = 300)
...
# plot genetic progress per generation
png("Scenario2.png", width = 265, height = 125, units='mm',res = 300)
plot_g_prog(genMean)
dev.off()
```
...
# plot genetic progress per generation
png("Scenario3.png", width = 265, height = 125, units='mm',res = 300)
plot_g_prog(genMean)
dev.off()
```
...
png("Scenario4.png", width = 265, height = 125, units='mm',res = 300)
plot_g_prog(genMean)
dev.off()
```
...
png("Scenario5.png", width = 265, height = 125, units='mm',res = 300)
plot_g_prog(genMean)
dev.off()
...
png("Scenario6.png", width = 265, height = 125, units='mm',res = 300)
plot_g_prog(genMean)
dev.off()
